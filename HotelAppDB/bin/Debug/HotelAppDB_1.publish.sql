...
GO
PRINT N'The following operation was generated from a refactoring log file c7d9e4aa-94f3-4da1-9d28-6a620f6b21f6';

PRINT N'Rename [dbo].[Rooms].[RoomTypesId] to RoomTypeId';


GO
EXECUTE sp_rename @objname = N'[dbo].[Rooms].[RoomTypesId]', @newname = N'RoomTypeId', @objtype = N'COLUMN';
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'c7d9e4aa-94f3-4da1-9d28-6a620f6b21f6')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('c7d9e4aa-94f3-4da1-9d28-6a620f6b21f6')
